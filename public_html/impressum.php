...
<main>
  ...
  <ul>
    <li>Steffen Bosse (steffen.bosse@student.jade-hs.de), Matrikelnummer: 6052231</li>
...
<h2>Inhaltliche Quellen</h2>
    ...
    <ul>
      ...
      <li><a href="https://www.kribbelbunt.de/artikel/news/blaetter-vorlage/" target="_blank">Kribbelbunt – Blätter Vorlage</a></li>
      <li><a href="https://malvorlagen-seite.de/malvorlage-umweltschutz/" target="_blank">Malvorlagen – Umweltschutz</a></li>
      <li><a href="https://raskrasil.com/image/raskrasil-com-new-coloring-pages-recycling-5/" target="_blank">Raskrasil – Recycling Ausmalbild</a></li>
      <li><a href="https://allaroundfamily.de/lernuhren-fuer-kinder-jahreszeiten-wochentage-wetter/" target="_blank">AllAroundFamily – Lernuhren</a></li>
      <li><a href="https://www.kikaninchen.de/kika-baumhaus/selbermachen/basteln/mach-mit-jahreszeiten-baum-108.html" target="_blank">Kikaninchen – Jahreszeitenbaum</a></li>
    ...
    <ul>
      <li>
        ...
        Autoren: Bärbel Oftring, Holger Haag<br>
        Umfassendes Sachbuch mit Bastelideen, Steckbriefen und Spielen.<br>
        <a href="https://www.thalia.de/shop/home/artikeldetails/A1053095006" target="_blank">Bei Thalia ansehen</a>
      </li>
      <li>
        <strong>Egon Eichhorn und der wilde Müll im Wald</strong><br>
        Autorin: Alina Gries<br>
        Sachgeschichte über heimische Waldtiere und die Folgen unachtsamer Müllentsorgung.<br>
        <a href="https://www.thalia.de/shop/home/artikeldetails/A1070097856" target="_blank">Bei Thalia ansehen</a>
      </li>
      <li>
        <strong>Komm mit uns in den Wald</strong><br>
        Autor: Peter Wohlleben<br>
        Den Wald entdecken und dabei das Lesen lernen.<br>
        <a href="https://www.thalia.de/shop/home/artikeldetails/A1073146969" target="_blank">Bei Thalia ansehen</a>
      </li>
      <li>
        <strong>Was fressen die Tiere im Wald?</strong><br>
        Autor: Peter Wohlleben<br>
        Vom Igel bis zum Schmetterling – spannende Einblicke für junge Naturfans.<br>
        <a href="https://www.thalia.de/shop/home/artikeldetails/A1066117193" target="_blank">Bei Thalia ansehen</a>
      </li>
      <li>
        <strong>Tiere im Wald</strong><br>
        Autor: Bernd Pöppelmann<br>
        Mal- und Zeichenbuch über unsere heimische Tierwelt – kreativ entdecken.<br>
    ...
    <ul>
      <li>
        ...
        Hörspielwissen über den Wald für Kinder von 4–7 Jahren.<br>
        <a href="https://www.thalia.de/shop/home/artikeldetails/A1009060835" target="_blank">Bei Thalia ansehen</a>
      </li>
      <li>
        <strong>WAS IST WAS – Wilde Wälder / Lebendiger Boden</strong><br>
        Verlag: Tessloff Verlag<br>
        Zwei spannende Themen auf einer CD – mit viel Waldwissen und Naturgeräuschen.<br>
        <a href="https://www.thalia.de/shop/home/artikeldetails/A1036069846" target="_blank">Bei Thalia ansehen</a>
      </li>
      <li>
        <strong>Kleine Helden im Wald</strong><br>
        Autor: Matthias Meyer-Göllner<br>
        Ein musikalisches Naturerlebnis mit Playback-Versionen für Kinder.<br>
        <a href="https://www.jumboverlag.de/Kleine-Helden-im-Wald-CD" target="_blank">Bei Jumbo Verlag ansehen</a>
      </li>
      <li>
        <strong>Im Wald – Was hör ich da?</strong><br>
        Autor: Jens-Uwe Bartholomäus<br>
        Ein Geräuschequiz für Kinder mit spannender Waldgeschichte und vielen Tierlauten.<br>
    ...
    <ul>
      <li>
        ...
        Reportagen mit echten Tieren, spannend erzählt.<br>
      ...
      <li>
        <strong>Wissen macht Ah!: Ab in den Wald!</strong><br>
        Spannendes aus dem Wald – von Baumwipfeln bis Wurzelwerk.<br>
        <a href="https://kinder.wdr.de/tv/wissen-macht-ah/av/video-ab-in-den-wald-100.html" target="_blank">Video ansehen</a>
      </li>
      <li>
        <strong>Lebensgemeinschaft Wald</strong><br>
        Einblick in das komplexe Ökosystem des Waldes.<br>
      ...
      <li>
        <strong>Unsere Wälder</strong><br>
        Wie Bäume miteinander kommunizieren – erklärt mit beeindruckenden Bildern.<br>
        <a href="https://www.zdf.de/dokus/unsere-waelder-108" target="_blank">Zur Terra X-Doku</a>
      </li>
      <li>
        <strong>Die Maus: Wer lebt unter einem Stein im Wald?</strong><br>
        Entdecke mit der Maus eine verborgene Welt unter einem Stein!<br>
  ...
  <li>
    ...
    Ein strategisches Kartenspiel rund um ein ökologisches Waldsystem.<br>
    <a href="https://www.thalia.de/shop/home/artikeldetails/A1069032393" target="_blank">Bei Thalia ansehen</a>
  </li>
  <li>
    <strong>Kosmos: Baumkronen</strong><br>
    Ein wunderschönes Zwei-Personen-Spiel – Regenwald aufbauen und entdecken.<br>
    <a href="https://www.thalia.de/shop/home/artikeldetails/A1060084139" target="_blank">Bei Thalia ansehen</a>
  </li>
  <li>
    <strong>Quelle &amp; Meyer – Natur-Memo Wald</strong><br>
    64 Karten für spielerisches Lernen mit Tieren und Pflanzen des Waldes.<br>
    <a href="https://www.thalia.de/shop/home/artikeldetails/A1046795929" target="_blank">Bei Thalia ansehen</a>
  </li>
  <li>
    <strong>Blatt-Detektivbogen</strong><br>
    Mache einen Waldspaziergang und finde verschiedene Blattformen!<br>
      <a href="https://www.blattdetektiv.de" target="_blank">Eigenanfertigung</a>
  </li>
  <li>
    <strong>Kreuzworträtsel Wald (Bildrätsel)</strong><br>
    Teste dein Wissen über den Wald mit einem spannenden Bilderrätsel!<br>
    <a href="https://www.grundschule-arbeitsblaetter.de/raetsel/kreuzwortraetsel/#google_vignette" target="_blank">Zur Webseite</a>
  </li>
  <li>
    <strong>Kreuzworträtsel Wald – Schulrätsel</strong><br>
    Teste dein Wissen über den Wald mit einem Kreuzworträtsel!<br>
    <a href="https://www.schulraetsel.de/raetsel_der-wald_74708.html" target="_blank">Zur Webseite</a>
  </li>
  <li>
    <strong>Jolinchens Waldquiz</strong><br>
    Teste dein Wissen mit lustigen Fragen zu Tieren und Natur.<br>
    <a href="https://www.aok.de/pk/magazin/cms/fileadmin/gemeinschaftlich/pdf/jolinchen-waldraetsel-oktober.pdf" target="_blank">PDF auf AOK-Webseite ansehen</a>
  </li>
    <li>
